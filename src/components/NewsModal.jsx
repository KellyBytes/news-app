        ...
        {article && (
          <>
            <img
              ...
              alt={article.title}
              className="modal-image w-full h-auto max-h-56 2xl:max-h-64 object-cover rounded-xl opacity-80"
            />
            ...
            <p className="modal-content-text text-sm 2xl:text-base mt-6 2xl:mt-8 leading-6 2xl:leading-8 text-neutral-200">
              {article.content}
            </p>
            <div className="flex justify-between items-center w-full">
              <a
                ...
                className="read-more-link w-42 sm:w-46 inline-block bg-gradient-to-r from-purple-400 to-indigo-500 mt-6 2xl:mt-8 py-4 px-6 text-neutral-50 rounded-[4rem] text-sm xl:text-base text-center uppercase tracking-widest active:translate-y-0.5"
              >
                Read More
              </a>
              <i
